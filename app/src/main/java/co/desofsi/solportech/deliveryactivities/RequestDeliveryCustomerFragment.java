...
import co.desofsi.solportech.adaptersdelivery.OrderListDeliveryAdapter;
import co.desofsi.solportech.models.OrderRequestDelivery;
import co.desofsi.solportech.routes.Routes;

public class RequestDeliveryCustomerFragment extends Fragment {
    private View view;
    ...
    public RequestDeliveryCustomerFragment() {
    }
    ...
    private void getOrders() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Routes.GET_REQUEST_DELIVERY_CUSTOMER,
                        ...
                        try {
                            ...
                            if (object.getBoolean("success")) {
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    ...
                                    if(!order_request.getStatus_request().equals("enviado")){
