package co.desofsi.solportech.deliveryactivities;
...
import co.desofsi.solportech.maps.RouteDeliveryActivity;
import co.desofsi.solportech.models.DateClass;
import co.desofsi.solportech.models.DetailOrder;
import co.desofsi.solportech.models.OrderRequestDelivery;
...
public class DeliveryDetailActivity extends AppCompatActivity {
    ...
    private OrderRequestDelivery order;
    private static final int PERMISSION_STORAGE_CODE = 1000;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delevery_detail);

            order = new OrderRequestDelivery();
            order = (OrderRequestDelivery) getIntent().getExtras().getSerializable("order");
            init();
            eventsButtons();
            loadReviewOrder();
            getOrdersDetail();
            if(order.getStatus_request().equals("aceptado")){
    ...
    public void init() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DeliveryDetailActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    public void eventsButtons() {
        ...
        btn_map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DeliveryDetailActivity.this, RouteDeliveryActivity.class);
    ...
    public void completeDelivery() {
        String url = Routes.COMPLETE_DELIVERY + "/" + order.getId();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (object.getBoolean("success")) {
                                Intent intent = new Intent(DeliveryDetailActivity.this, HomeActivity.class);
                                startActivity(intent);
                            }
                        } catch (Exception e) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DeliveryDetailActivity.this);
        ...
        switch (requestCode) {
            case PERMISSION_STORAGE_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(DeliveryDetailActivity.this, "Habilite el permiso de almacenamiento", Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (object.getBoolean("success")) {
                                ...
                                ReviewListProductstAdapter orderListAdapter = new ReviewListProductstAdapter(DeliveryDetailActivity.this, lis_products);
