...
import co.desofsi.solportech.activities.DetailOrderActivity;
import co.desofsi.solportech.adapters.ListCategoriesAdapter;
...
public class OrderFragmentMerchant extends Fragment {
    ...
    private void init() {
      ...
      //  LinearLayoutManager mLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
        ...
        text_baner_name.setText("SOLPROTECH");
        text_baner_des.setText("Soluciones Tecnológicas");
